...
$pt_tabs->tab(__('Basic', 'typerocket-ui'))->setFields(
    $form->row(
        $form->text('Singular', ['placeholder' => __('Required', 'typerocket-ui')])->markLabelRequired(),
        $form->text('Plural', ['placeholder' => __('Not required', 'typerocket-ui')])
    ),
    $form->row(
        $form->text('Post Type ID', ['placeholder' => $singular ?: __('Default value will be singular', 'typerocket-ui')]),
...
$tax_tabs->tab('Basic')->setFields(
    $form->row(
        $form->text('Singular', ['placeholder' => __('Generates plural form automatically', 'typerocket-ui')])->markLabelRequired(),
        $form->text('Plural', ['placeholder' => __('Not required', 'typerocket-ui')])
    ),
    $form->row(
        $form->text('Taxonomy ID', ['placeholder' => __('Default value will be singular', 'typerocket-ui')]),
        $form->text('Slug', ['placeholder' => __('Default value will be plural', 'typerocket-ui')])
    ),
...
$meta_tabs->tab('Basic')->setFields(
    ...
    $form->text('Meta Box ID')->setHelp(__('Default value will be generated by the title field', 'typerocket-ui')),
