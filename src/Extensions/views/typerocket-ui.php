...
$pt_tabs->tab(__('Basic', 'typerocket-ui'))->setFields(
    ...
    $form->row(
        $form->text('Post Type ID', ['placeholder' => __('Alphanumeric and underscores only', 'typerocket-ui')])->maxlength(20)->markLabelRequired(),
...
$tax_tabs->tab('Basic')->setFields(
    ...
    $form->row(
        $form->text('Taxonomy ID', ['placeholder' => __('Alphanumeric and underscores only', 'typerocket-ui')])->maxlength(32)->markLabelRequired(),
        $form->text('Slug', ['placeholder' => __('Default value will be plural', 'typerocket-ui')])
    ),
...
$meta_tabs->tab('Basic')->setFields(
    ...
    $form->text('Meta Box ID')->setHelp(__('Default value will be generated by the title field', 'typerocket-ui'))->markLabelRequired(),
