 ...
 * @return bool
 */
function tr_mb_ucwords($str, $delimiters = " \t\r\n\f\v" ) {
 ...
 * @return string
 */
function tr_array_reduce_allowed_str($array) {
    $reduced = '';
...
function tr_class_names($defaults, $classes = null, $failed = '') {
    if(!$result = tr_array_reduce_allowed_str(is_array($defaults) ? $defaults : $classes)) {
